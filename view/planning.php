    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        foreach ($agenda_event->getItems() as $event) {
          ...
          array_push($destinationPrev, $event->location);
          $_SESSION['alldestination'] = $destinationPrev;
          ...
          <tr>
            <td>
              <?php echo $trajet->routes[0]->legs[0]->start_address;?>
            </td>
            <td>
              <?php //echo $event->location; ?>
              <?php echo $trajet->routes[0]->legs[0]->end_address;?>
